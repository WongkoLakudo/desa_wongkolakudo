...
<body>
		...
		<section class="section-divider textdivider divider6">
			...
			<br/>
			<br/>
				<p><h2 style="color:white; background-color: #29447E;"><marquee>WISATA Buton Tengah</marquee></h2></p>
				<hr>
				<p style="text-align : center; ">Wista Buton Tengah siap membantu Anda mencari wisata di Buton Tengah</p>
			</div><!-- container -->
		</section><!-- section -->
		</br>
...
<tr>
		...
		<td><?php echo "<img border=2 src='admin/admin/rating/foto/$d[gambar_wisata]' border=0 width=100 height=100 "?></td>
	</tr>

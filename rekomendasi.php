		...
		<section class="section-divider textdivider divider4">
			...
			<br/>
			<br/>
				<p><b><h2 style="color:white;"><marquee>STRUKTUR DARI DESA WONGKO LAKUDO</marquee></h2></b></p>
				<hr>
				<p>Berikut Adalah Anggota Badan Permusyawaratan Di Desa Wongko Lakudo </p>
			</div><!-- container -->
		</section><!-- section -->
